...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        img1=Image.open(r"image\hotel1.png")
        ...
        #================title=================
        lbl_title=Label(self.root,text="Hotel Managment System",font=("times new roman",40,"bold"),bg="black",fg="gold",bd=4,relief=RIDGE)
        lbl_title.place(x=0,y=140,width=1530,height=70)
        
        
        #================main frame=================
        main_frame=Frame(self.root,bd=4,relief=RIDGE)
        main_frame.place(x=0,y=210,width=1530,height=620)
        ...
        room_btn=Button(btn_frame,text="ROOM",width=22,command=self.roombooking,font=("times new roman",14,"bold"),bg="black",fg="gold",bd=4,cursor="hand1")
        room_btn.grid(row=1,column=0,pady=1)
        
        detail_btn=Button(btn_frame,text="DETAILS",width=22,command=self.detailes_room,font=("times new roman",14,"bold"),bg="black",fg="gold",bd=4,cursor="hand1")
        ...
        img3=Image.open(r"image\slide3.jpg")
        ...
        img4=Image.open(r"image\myh.jpg")
